...
{
	static void PrintMessage(const FString& Message, const FColor& Color = FColor::Red)
	{
		if (GEngine)
		{
	...
	static EAppReturnType::Type ShowMessageDialog(EAppMsgType::Type MsgType, const FString& Message, bool bShowMessageAsWarning = true)
	{
